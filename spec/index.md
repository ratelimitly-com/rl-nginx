...
For `rl-c-client v2.0.0`, the following upstream documents are the normative
dependency contract:

- [Public API and operation model](https://github.com/ratelimitly-com/rl-c-client/blob/v2.0.0/docs/api.md);
- [event-loop I/O, DNS, timer, buffer, and steering contract](https://github.com/ratelimitly-com/rl-c-client/blob/v2.0.0/IO_ABSTRACTION.md); and
- [client design and ownership boundary](https://github.com/ratelimitly-com/rl-c-client/blob/v2.0.0/DESIGN.md).
