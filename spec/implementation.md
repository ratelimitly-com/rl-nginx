...
[Choosing an integration layer](https://github.com/ratelimitly-com/rl-c-client/blob/v2.0.0/docs/api.md#choosing-an-integration-layer)
and the host callbacks in its
[Event-Loop Integration](https://github.com/ratelimitly-com/rl-c-client/blob/v2.0.0/IO_ABSTRACTION.md)
