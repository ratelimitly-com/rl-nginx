...
- nginx directives for configuring the C-client DNS refresh policy (replay
  count, replay/preference schedules, final receive time, and completion
  delivery are now configurable through `ratelimitly_policy custom`);
