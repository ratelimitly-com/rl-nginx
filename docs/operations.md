...
[DNS contract](https://github.com/ratelimitly-com/rl-c-client/blob/v2.0.0/IO_ABSTRACTION.md#dns)
and
...
| --- | --- | --- |
| Valid allow | Consume requested resources, if any, and enter content | Consume requested resources, if any, and enter content |
...
[`RCLIENT_ERR_TIMEOUT`](https://github.com/ratelimitly-com/rl-c-client/blob/v2.0.0/docs/api.md#error-codes).
