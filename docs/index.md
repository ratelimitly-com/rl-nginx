...
The locked
[`rl-c-client v0.5.1`](https://github.com/ratelimitly-com/rl-c-client/tree/v0.5.1)
documentation is authoritative for behavior owned by the client:

- [resource requests and independent latency reports](https://github.com/ratelimitly-com/rl-c-client/blob/v0.5.1/README.md#core-operations);
- [credentials and API-key quotas](https://github.com/ratelimitly-com/rl-c-client/blob/v0.5.1/docs/api.md#credentials);
- [content-defined bucket and latency-tracker IDs](https://github.com/ratelimitly-com/rl-c-client/blob/v0.5.1/docs/api.md#content-defined-ids);
- [resource-request HA policy and deduplication TTL](https://github.com/ratelimitly-com/rl-c-client/blob/v0.5.1/docs/api.md#resource-request-ha-policy);
- [DNS refresh](https://github.com/ratelimitly-com/rl-c-client/blob/v0.5.1/docs/api.md#dns-refresh); and
- [client error codes](https://github.com/ratelimitly-com/rl-c-client/blob/v0.5.1/docs/api.md#error-codes).
