...
[resource requests and latency reports](https://github.com/ratelimitly-com/rl-c-client/blob/v2.0.0/README.md#core-operations).
...
automatically fetch the locked public `rl-c-client` `v2.0.0` release. No private
...
and
[Error Codes](https://github.com/ratelimitly-com/rl-c-client/blob/v2.0.0/docs/api.md#error-codes)
...
| `rl-c-client` | `v2.0.0` at `58c767d0e6807fcefac29000a8ab94ae8f54fd9b` |
...
- [RateLimitly operations in rl-c-client v2.0.0](https://github.com/ratelimitly-com/rl-c-client/blob/v2.0.0/README.md#core-operations)
- [C-client v2.0.0 public API and policy](https://github.com/ratelimitly-com/rl-c-client/blob/v2.0.0/docs/api.md)
