...
Builds fetch the public `rl-c-client` `v0.4.0` release at the full commit in
...
[`v0.4.0 LICENSE`](https://github.com/ratelimitly-com/rl-c-client/blob/v0.4.0/LICENSE).
